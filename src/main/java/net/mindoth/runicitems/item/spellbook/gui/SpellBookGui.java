...
public class SpellBookGui extends AbstractContainerScreen<SpellbookContainer> {
    public SpellBookGui(SpellbookContainer container, Inventory playerInventory, Component name) {

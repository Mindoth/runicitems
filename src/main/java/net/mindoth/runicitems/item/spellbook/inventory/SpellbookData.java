...
public class SpellbookData {
    ...
    public SpellbookData(UUID uuid, CompoundTag incomingNBT) {
        this.uuid = uuid;
        this.tier = SpellbookType.values()[Math.min(incomingNBT.getInt("Tier"), SpellbookType.SPELL_BOOK.ordinal())];
    ...
    public static Optional<SpellbookData> fromNBT(CompoundTag nbt) {

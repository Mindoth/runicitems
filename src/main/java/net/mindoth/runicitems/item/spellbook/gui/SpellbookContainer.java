...
public class SpellbookContainer extends AbstractContainerMenu {
    ...
    public static SpellbookContainer fromNetwork(final int windowId, final Inventory playerInventory, FriendlyByteBuf data) {
    ...
    public SpellbookContainer(final int windowId, final Inventory playerInventory, UUID uuidIn, SpellbookType tierIn, IItemHandler handler) {

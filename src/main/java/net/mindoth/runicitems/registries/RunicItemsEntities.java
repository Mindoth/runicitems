...
import net.mindoth.runicitems.spell.fireprojectile.FireProjectileEntity;
import net.mindoth.runicitems.spell.deafening_blast.DeafeningBlastEntity;
import net.mindoth.runicitems.spell.healingbolt.HealingBoltEntity;
import net.mindoth.runicitems.spell.iceprojectile.IceProjectileEntity;
import net.mindoth.runicitems.spell.icicle.IcicleEntity;
import net.mindoth.runicitems.spell.magicalcloud.MagicalCloudEntity;
import net.mindoth.runicitems.spell.magicspark.MagicSparkEntity;
import net.mindoth.runicitems.spell.meteor.MeteorEntity;
import net.mindoth.runicitems.spell.stormprojectile.StormProjectileEntity;
import net.mindoth.runicitems.spell.stormycloud.StormyCloudEntity;
import net.mindoth.runicitems.spell.tornado.TornadoEntity;
import net.mindoth.runicitems.spell.unstablecloud.UnstableCloudEntity;
import net.mindoth.runicitems.spell.witherskull.WitherSkullEntity;

...
public class MagicSparkRenderer<T extends MagicSparkEntity> extends EntityRenderer<T> {

    public MagicSparkRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        return new ResourceLocation(RunicItems.MOD_ID, "textures/spells/magic_spark.png");
    }
}

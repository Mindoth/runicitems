...
public class MagicalCloudRenderer<T extends MagicalCloudEntity> extends EntityRenderer<T> {

    public MagicalCloudRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

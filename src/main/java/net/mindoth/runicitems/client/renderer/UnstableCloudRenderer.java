...
import net.mindoth.runicitems.entity.spell.UnstableCloudEntity;
...
public class UnstableCloudRenderer<T extends UnstableCloudEntity> extends EntityRenderer<T> {

    public UnstableCloudRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

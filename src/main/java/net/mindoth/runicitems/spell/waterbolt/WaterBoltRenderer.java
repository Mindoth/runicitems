...
public class WaterBoltRenderer extends EntityRenderer<WaterBoltEntity> {
    ...
    public WaterBoltRenderer(EntityRendererManager renderManager) {
        super(renderManager);
    }
    ...
    @Override
    public void render(WaterBoltEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {

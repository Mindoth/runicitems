...
public class HealingBoltRenderer<T extends HealingBoltEntity> extends EntityRenderer<T> {

    public HealingBoltRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        return new ResourceLocation(RunicItems.MOD_ID, "textures/spells/healing_bolt.png");
    }
}

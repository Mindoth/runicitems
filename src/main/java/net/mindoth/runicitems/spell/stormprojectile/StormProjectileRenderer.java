package net.mindoth.runicitems.spell.stormprojectile;
...
public class StormProjectileRenderer<T extends StormProjectileEntity> extends EntityRenderer<T> {

    public StormProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

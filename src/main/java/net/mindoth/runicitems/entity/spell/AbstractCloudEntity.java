...
public class AbstractCloudEntity extends ThrowableProjectile {

    protected AbstractCloudEntity(EntityType<? extends AbstractCloudEntity> entityType, Level level) {
    ...
    protected AbstractCloudEntity(EntityType<? extends AbstractCloudEntity> pEntityType, Level pLevel, LivingEntity owner, Entity caster, IItemHandler itemHandler, int slot,

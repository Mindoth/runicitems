...
public class SpellBuilder {
    ...
    public static void castFromWand(PlayerEntity owner, ItemStack ogStack) {
        SpellbookData ogData = SpellbookItem.getData(ogStack);
        final IItemHandler handler = ogData.getHandler();
        cast(owner, owner, handler, 0, owner.xRot, owner.yRot);
    }

    public static void cast(PlayerEntity owner, Entity caster, IItemHandler itemHandler, int slot, float xRot, float yRot) {
    ...
    private static void doSpell(PlayerEntity owner, Entity caster, IItemHandler itemHandler, int slot, HashMap<Item, Integer> effects, SpellRuneItem rune, float xRot, float yRot) {

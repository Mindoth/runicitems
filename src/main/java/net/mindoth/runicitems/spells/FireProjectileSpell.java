...
import net.mindoth.runicitems.entity.spell.FireProjectileEntity;
...
public class FireProjectileSpell extends AbstractSpell {
    ...
    protected static AbstractProjectileEntity getProjectile(Level level, LivingEntity owner, Entity caster, IItemHandler itemHandler, int slot, HashMap<Item, Integer> effects) {
        return new FireProjectileEntity(level, owner, caster, itemHandler, slot, effects);
    }

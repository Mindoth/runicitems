...
import net.mindoth.runicitems.entity.spell.IceProjectileEntity;
...
public class IceProjectileSpell extends AbstractSpell {
    ...
    protected static AbstractProjectileEntity getProjectile(Level level, LivingEntity owner, Entity caster, IItemHandler itemHandler, int slot, HashMap<Item, Integer> effects) {
        return new IceProjectileEntity(level, owner, caster, itemHandler, slot, effects);
    }
